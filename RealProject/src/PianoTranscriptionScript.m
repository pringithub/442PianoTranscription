...
% If script files, close the reference to the ILY file to prevent system
% locking
try
    ...
    theKeysAre = getPressedKeysFromImage(img_rot, keyMap)
...
% Close the file reference to the ILY file
catch
   fclose(fileID);
end